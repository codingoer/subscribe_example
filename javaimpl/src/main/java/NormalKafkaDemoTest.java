...
public class NormalKafkaDemoTest {
    private static final Logger log = LoggerFactory.getLogger(NormalKafkaDemoTest.class);
    ...
    public static Properties getConfigs() {
        ...
        properties.setProperty(INITIAL_CHECKPOINT_NAME, "1589771280");
